...
export default function ModerationPage({ authToken, initialProjects, initialTotalPages, initialAnalytics }) {
                ...
                <div className="content content--padding" style={{ marginBottom: "15px" }}>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={analytics.approvedProjects}>
                            ...
                            <XAxis
                                dataKey="date"
                                tickFormatter={(date) => formatDate(date, locale)}
                                style={{ fontSize: "12px" }}
                                stroke="var(--theme-color-text-primary)" strokeOpacity={0.1}
                            />
                            <YAxis
                                dataKey="count"
                                style={{ fontSize: "12px" }}
