...
import ProjectMembers from "@/components/project/settings/ProjectMembers";
...
export default async function Page({ params }) {
    ...
    if(!res.ok) {
        return <div>{tProject("projectNotFound")}</div>;
    }
    ...
    return <ProjectMembers project={project} authToken={authToken} />;
}