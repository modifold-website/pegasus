    ...
    return (
        <div className="sidebar">
            <div className="sidebar__main">
                <Link href={`/mod/${project.slug}`} scroll={false} className="sidebar-item sidebar-item--profile" data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/description`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/description`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/links`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/links`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/versions`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/versions`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/gallery`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/gallery`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/tags`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/tags`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/license`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/license`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/analytics`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/analytics`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link href={`/mod/${project.slug}/settings/moderation`} scroll={false} className={`sidebar-item ${isActive(`/mod/${project.slug}/settings/moderation`) ? "sidebar-item--active" : ""}`} data-ripple>
