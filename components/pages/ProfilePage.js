    ...
    const socialIcons = {
        ...
        x: (
            <svg width="20" height="21" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M0.0180316 25H2.10969L10.296 15.3012L16.8054 25H24L14.299 10.6172L23.2066 0H21.0789L13.3434 9.18442L7.1405 0H0L9.37641 13.9236L0.0180316 25ZM2.88505 1.63483H6.1127L21.0969 23.457H17.8332L2.88505 1.63483Z" fill="#307df0"/>
            </svg>
        ),
        discord: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
