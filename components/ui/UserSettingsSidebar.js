            ...
            <div className="sidebar__main">
                ...
                {showSettings && (
                    <>
                        ...
                        <Link href="/settings/appearance" className={`sidebar-item ${isActive("/settings/appearance") ? "sidebar-item--active" : ""}`} data-ripple>
                        ...
                        <Link href="/settings/language" className={`sidebar-item ${isActive("/settings/language") ? "sidebar-item--active" : ""}`} data-ripple>
                        ...
                        <Link href="/settings/account-security" className={`sidebar-item ${isActive("/settings/account-security") ? "sidebar-item--active" : ""}`} data-ripple>
