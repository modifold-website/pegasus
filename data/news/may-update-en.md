...
- Creator Badge instead of the old verification.
- **Liked Projects** page for saved projects.
- Notifications about new project versions.
- Updated mods catalog with recommended projects and sorting by recent updates.
- New project cards.
- Dependency selection when publishing versions.
...
We like [Simon’s thought](https://x.com/Simon_Hypixel/status/2017380109213208850): if he were a Hytale modder today, he would focus on making mods more accessible and building his name.
...
- Updated the login window.
- Updated the site footer.
- Updated the site favicon.
- Updated the logo on the home page.
- Improved modal animations across the site.
- Fixed icons in the social links block.
- Made the clear filters button cleaner and disabled when filters are empty.
- Latest projects now appear in the home page showcase.
- The marquee on the home page now pauses when hovering a mod badge.
