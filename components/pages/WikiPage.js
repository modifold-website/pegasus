...
const renderPages = (pages, projectSlug, activeSlug, level = 0) => {
    ...
    return (
        <ul className={`wiki-pages-list wiki-pages-list--level-${level}`}>
            {pages.map((page, index) => {
                ...
                return (
                    <li key={page.id}>
                        <Link href={`/mod/${projectSlug}/wiki/${page.slug}`} className={`wiki-pages-link ${isActive ? "wiki-pages-link--active" : ""}`} data-ripple>
                            {isFirstTopLevelPage ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star-icon lucide-star">
                        ...
                        {Array.isArray(page.children) && page.children.length > 0 && renderPages(page.children, projectSlug, activeSlug, level + 1)}
                    </li>
                );
            })}
        </ul>
                                ...
                                <section className="wiki-content">
                                    <div className="content content--padding wiki-content__header">
                                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                                            <svg style={{ fill: "none" }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open-icon lucide-book-open">
                                                <path d="M12 7v14"/>
                                                <path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>
                                            </svg>
