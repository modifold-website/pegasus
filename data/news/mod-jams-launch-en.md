...
- create a mod jam page;
- add a title, description, rules, avatar, and cover image;
- set submission and voting dates;
- send a jam to moderation before publishing;
- submit a project to an active jam;
- vote for entries;
- assign jury members;
- create nominations like "Best Gameplay", "Most Original Idea", or "Community Choice";
- view finished events and results.
