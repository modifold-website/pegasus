                                    ...
                                    <div className="popover" tabIndex={0} style={{ "--width": "max-content", "--top": "46px", "--position": "absolute", "--left": "auto", "--right": "0", "--bottom": "auto", "--distance": "8px" }}>
                                        <div className="popover__scrollable" style={{ "--max-height": "auto" }}>
                                            {user && (project.permissions?.can_edit_details || project.user_id === user.id) && (
                                                <Link style={{ width: "100%" }} className="context-list-option context-list-option--with-art" href={getProjectPath(project, "/settings")} onClick={() => setIsActionsOpen(false)}>
                                                    <div className="context-list-option__art context-list-option__art--icon">
                                                        <svg style={{ fill: "none" }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-settings-icon lucide-settings">
